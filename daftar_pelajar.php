            ...
            <tr>
              ...
              <td scope="col"><table width="580" height="132" border="0">
                  ...
                  <td height="24">Email</td>
                    <td><span class="style50">:</span></td>
                    <td><label>
                      <input type="text" name="email" id="email" size="5"  placeholder="No.Matrik"/>
					  <input type="text" name="email2" id="email2" size="15" readonly  value="@siswa.uthm.edu.my"/>
                  </tr>
				  ...
				  <tr>
                    ...
                    <td><span class="style50">:</span></td>
                    <td><label>
                      <input type="text" name="pengesahan_email" id="pengesahan_email" size="5"  placeholder="No.Matrik"/>
					  <input type="text" name="pengesahan_email2" id="pengesahan_email2" size="15" readonly  value="@siswa.uthm.edu.my"/>
                  </tr>
				   ...
				   <tr>
                    ...
                    <td><span class="style50">:</span></td>
                    <td><label>
					<select name="no_tel2" id="no_tel2" class="input">
