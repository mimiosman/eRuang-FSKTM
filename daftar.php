...
$().ready(function() {	
	...
	$("#borang_daftar").validate({
		...
		messages: {
			...
			no_id: {
				required: "<br>Sila masukkan nombor matrik/ID anda",
            ...
            <tr>
              ...
              <td scope="col"><table width="580" height="132" border="0">
                   ...
                   <td height="24">Status</td>
                    ...
                    <td><label><span class="style52">
                      <select name="status" id="status"  class="input" onchange="if (this.value) window.location.href=this.value"/>
						...
						<option value="daftar_pensyarah.php">Pensyarah</option>
					  </select> 
                    </span> </label></td></center>
                 
				  
                  <!--<tr>
                    <td height="24">No Matrik/ID</td>
                    <td><span class="style50">:</span></td>
                    <td><label><span class="style52">
                 ...
                 <!-- <tr>
                    ...
                    <td><span class="style50">:</span></td>
                    <td><label>
                      <input type="text" name="email" id="email" size="10"  class="input" placeholder="No.Matrik/ID"/>
					   <!--<input type="text" name="email2" id="email" size="15" readonly class="input" value="@siswa.uthm.edu.my"/>
					 <select name="email2" >
										<option value="@siswa.uthm.edu.my">@siswa.uthm.edu.my</option>
										<option value="@gmail.com">@uthm.edu.my</option>
										</select>
					  
                      <span class="style52">contoh : ci140132@siswa.uthm.my</span> </label></td> 
                  </tr>-->
				  ...
				  <!-- <tr>
                    ...
                    <td><span class="style50">:</span></td>
                    <td><label>
                      <input type="text" name="pengesahan_email" id="pengesahan_email" size="10" class="input" />
					   <select name="pengesahan_email2" >
										<option value="@siswa.uthm.edu.my">@siswa.uthm.edu.my</option>
										<option value="@gmail.com">@uthm.edu.my</option>
										</select>
                      <span class="style52">contoh : ci140132@siswa.uthm.my</span> </label></td> 
				   ...
				   <tr>
                    ...
                    <td><span class="style50">:</span></td>
                    <td><label>
                      <input type="text" name="no_tel" id="no_tel" onkeypress="return isNumberKey(event)" maxlength="11" class="input" size="40"/>
                    </label></td>
                  </tr>-->
                </table>
            </tr>
