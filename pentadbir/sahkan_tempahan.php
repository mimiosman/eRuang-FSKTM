...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>
		...
		<li><a href="log_keluar.php" onclick="return checkConfirm2()" ><font color="red">Log Keluar</font></a></li>
		</ul>
...
<?php
            ...
            if($i%2==0){
				...
				echo "<b>TARIKH PERMOHONAN:</b> ".$row2['tarikh_mohon']. "<br>";
				echo "<b>MASA TEMPAHAN:</b> ".$row2['time']. "<br>";
				echo "<b>TARIKH TEMPAHAN:</b> ".$row2['date']."<br>";
				...
				echo "<b>STATUS TEMPAHAN:</b> <font color='goldenrod'>".$row2['status']."</font><br></div><br>";
				
				echo '<center><a href="lulus_tempahan.php?id='.$row2['id'].'" onclick="return checkConfirm()"><mark>LULUS TEMPAHAN</mark></a> &#10094;&#10095; <a href="batalkan_tempahan.php?id='.$row2['id'].'" onclick="return checkConfirm1()"><mark1>GAGAL TEMPAHAN</mark1></a></center></div>';
...
function checkConfirm(){
    return confirm('Adakah anda pasti ingin meluluskan tempahan ini?');
}
