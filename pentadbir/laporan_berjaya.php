...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			<a href="laporan_berjaya.php" class="active">Laporan Berjaya</a>
		...
		<font color="gray" size="2"><p align="center">
			...
			<div class="container">
                        ...
                        <div   align="left">   
                            ...
                            <div class="charts_container">
                                <div class="chart_container">
                                     <div class="alert alert-info">Graf  bilangan keseluruhan oleh pengguna yang telah <font color="green"><b>DILULUSKAN TEMPAHAN</b></font> mengikut bulan dan tahun.</div> <br> 
									 <form action="<?=$_SERVER['PHP_SELF'] ?>" method="POST">
										...
										<input type="submit" name="submit" class="submit" value="Jana Laporan" />
									...
									<?php 										
										if (isset($_POST['month'])) {	
											$month = $_POST['month'];
											$year = $_POST['year'];										
											$query = mysql_query("select nama_ruang, count(*) as num FROM tempahan  WHERE date LIKE '%-$month-$year' AND status='TEMPAHAN BERJAYA'") or die(mysql_error());
							...
							<?php 
								$myquery = "select nama_ruang, count(*) as num FROM tempahan WHERE status='TEMPAHAN BERJAYA' GROUP BY nama_ruang  ";
								if (isset($_POST['month'])) {
									$month = $_POST['month'];
									$year = $_POST['year'];
									$myquery = "select nama_ruang, count(*) as num FROM tempahan  WHERE date LIKE '%-$month-$year' and status='TEMPAHAN BERJAYA' GROUP BY nama_ruang";
								;
                            ...
                            <script type="application/javascript">
                               ...
                               $query = mysql_query($myquery) or die(mysql_error());
                                ...
                                chart1.colors = ['#006CFF', '#FF6600', '#34A038', '#945D59', '#93BBF4', '#F493B8','#FF0000','#FF0000'];
				...
				<?php 
					...
					$color = ['#006CFF', '#FF6600', '#34A038', '#945D59', '#93BBF4', '#F493B8','#FF0000','#FF0000'];
					$i = 0;
					$query = mysql_query($myquery) or die(mysql_error());
                    while ($row = mysql_fetch_array($query)) {
