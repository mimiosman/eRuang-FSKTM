...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			<a href="tempahan_terbaru.php" class="active">Tempahan Terbaru</a>
		...
		<div class="divTableCellhd">Pengesahan</div>
    </div>
...
<?php
            ...
            $sql = "select * FROM tempahan  where status='DALAM PROSES'  ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
            ...
            if($i%2==0){
				...
				echo '<div class="divTableCell" ><center><a href="sahkan_tempahan.php?id='.$row2['id'].'">Sahkan</a></center></div>';
			...
			<br>
			<center><?php 
			$sql = "select * FROM tempahan where status = 'DALAM PROSES' "; 
			...
			{
			echo '<style="width:100%"><font color=red> Maaf,tiada lagi sebarang tempahan dilakukan oleh pengguna.</font>';
			}
			...
			if($i <> $page){
            echo "<a href='tempahan_terbaru.php?page=".$i."' style='text-decoration: none;' >".'&nbsp;'."<font face='Verdana' size='2'>$i</font>"."</a> "; 
			}
			else { 
