...
<input type=hidden name=id value='$row[staf_id]'>
...
<br>No.ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=text name=staf_id readonly size=50 maxlength=20  value='$row[staf_id]'><br>

<br>Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=text name=status readonly size=50 maxlength=20 value='$row[status]'><br>

<br>No. Telefon&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=text name=no_tel size=50 maxlength=11 value='$row[no_tel]'  onkeypress='return isNumberKey(event)' placeholder='Contoh: 0112345678'><font color=red>* </font><br>


<br>Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=email name=email size=50 maxlength=20 value='$row[email]'><font color=red>* </font><br>

<br>Gambar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<img src='staf/$row[imej]' width='64' height='65' >
<br>Ganti Gambar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
