...
<tr>
  ...
  <div class="outerDiv">
		...
		<li><a href="log_keluar.php" onclick="return checkConfirm1()" ><font color="red">Log Keluar</font></a></li>
		</ul>
...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<div class="divTableCellhd">ID</div>
       
        <div class="divTableCellhd">Nama Ruang</div>
		<div class="divTableCellhd">Aras</div>
		  <center><div class="divTableCellhd">Aksi</div></center>
...
<?php
            ...
            $sql = "select * FROM ruang  ORDER BY id_ruang ASC LIMIT $start_from, $num_rec_per_page";
            ...
            if($i%2==0){
				...
				echo "<div class='divTableCell'>".$row2['id_ruang']."</div>";
                	
				echo "<div class='divTableCell2'>".$row2['nama_ruang']."</div>";
       
                echo "<div class='divTableCell'>".$row2['aras']."</div>";

               
			
				echo '<div class="divTableCell" ><center><a href="padam_ruang_proses.php?id_ruang='.$row2['id_ruang'].'" onclick="return checkConfirm()">Padam</a></center></div>';
			...
			{
			echo '<style="width:100%"><font color=red> Maaf,tiada data.</font>';
			}

			//echo "<a href='tempahan_terbaru.php?page=1'>".'|<'."</a> "; // Goto 1st page  

			for ($i=1; $i<=$total_pages; $i++) { 
			if($i <> $page){
            echo "<a href='padam_ruang.php?page=".$i."' style='text-decoration: none;' >".'&nbsp;'."<font face='Verdana' size='2'>$i</font>"."</a> "; 
			}
			else { 
			echo "<font face='Verdana' size='4' color=red>$i</font>";
			} /// Current page is not displayed as link and given font color red
			}
			//echo "<a href='tempahan_terbaru.php?page=$total_pages'>".'>|'."</a>"; // Goto last page
			?></center>
...
function checkConfirm(){
    return confirm('Adakah anda pasti ingin padam ruang ini?');
}
</script>
