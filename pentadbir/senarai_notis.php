...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			...
			<a href="senarai_notis.php" class="active">Senarai Notis</a>
		</div>
		</li><hr>
...
?>
		...
		<div class="divTableCellhd">Mesej</div>
		  <center><div class="divTableCellhd">Kemaskini</div></center>
...
<?php
            ...
            $sql = "select * FROM notis  ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
            ...
            if($i%2==0){
				...
				echo "<div class='divTableCell'>".$row2['status']."</div>";
       
                echo "<div class='divTableCell1'>".$row2['mesej']."</div>";

               
			
				echo '<div class="divTableCell" ><center><a href="padam_notis.php?id='.$row2['id'].'" onclick="return checkConfirm()">Padam</a></center></div>';
			...
			{
			echo '<style="width:100%"><font color=red> Maaf,tiada lagi sebarang notis dilakukan.</font>';
			}
			...
			if($i <> $page){
            echo "<a href='senarai_notis.php?page=".$i."' style='text-decoration: none;' >".'&nbsp;'."<font face='Verdana' size='2'>$i</font>"."</a> "; 
			}
			else { 
...
function checkConfirm(){
    return confirm('Adakah anda pasti ingin padam notis ini?');
}
</script>
