...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			...
			<a href="senarai_tempahan_gagal.php" class="active">Tempahan Gagal</a>
		</div>
		</li><hr>
...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<font color="gray"><b>SENARAI TEMPAHAN YANG GAGAL:</b></font><br><br>
			<font size="2"><li align="justify">Susunan senarai tempahan yang tidak lulus adalah mengikut yang terkini.</li></font>
...
<?php
            ...
            $sql = "select * FROM tempahan  where status = 'TEMPAHAN GAGAL' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
            ...
            if($i%2==0){
				...
				echo '<div class="divTableCell"><a href="senarai_tempahan_gagal2.php?id='.$row2['id'].'">'.$row2['id'].'</a></div>';
				...
				echo "<div class='divTableCell'><font color='red'>".$row2['status'];
			...
			<br>
			<center><?php 
			$sql = "select * FROM tempahan where status ='TEMPAHAN GAGAL' "; 
			...
			if($i <> $page){
            echo "<a href='senarai_tempahan_gagal.php?page=".$i."' style='text-decoration: none;' >".'&nbsp;'."<font face='Verdana' size='2'>$i</font>"."</a> "; 
			}
			else { 
