...
<form action="batal_tempahan_email.php" method="post">
	...
	<div class="form-group">
		...
		<input type="text" value="TEMPAHAN ANDA GAGAL" name="subject" readonly id="EMAIL" placeholder="Subject Line" required style="height: 30px; width: 170px;" />
	</div><br>
	
	<div class="control-group">
		<label for="name">Mesej:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
			<textarea name="message" id="desc"   placeholder="Mesej" required style="height: 160px; width: 300px;">Kepada <?php echo $nama ?> bernombor matrik <?php echo $no_id ?>, tempahan anda TIDAK BERJAYA diatas sebab-sebab tertentu. Berikut adalah maklumat tempahan yang telah anda lakukan: 
