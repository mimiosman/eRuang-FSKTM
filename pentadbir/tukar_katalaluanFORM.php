...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			...
			<a href="tukar_katalaluanFORM.php" class="active">Tukar Katalaluan</a>
		</div>
		</li><hr>
...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<?php
					...
					while($row = mysql_fetch_array($result))
					{
					echo "<h3>Tukar Katalaluan</h3>
          <form method=POST action=tukar_katalaluan.php>
         
          <p>Katalaluan Lama &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type=password maxlength=15 name='pass_lama'></p>
           <p>Katalaluan Baru 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type=password maxlength=15 name='pass_baru'></p>
           <p>Pengesahan Katalaluan Baru : <input type=password maxlength=15 name='pass_ulangi' ></p>
