...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<font color="gray"><b>MAKLUMAT PENEMPAH YANG TELAH DILULUSKAN:</b></font><br><br>
...
<?php
            ...
            $sql = "SELECT * FROM tempahan WHERE id='$_GET[id]' and status='TEMPAHAN BERJAYA'";
            ...
            if($i%2==0){
				...
				//echo '<center><a href="lulus_tempahan.php?id='.$row2['id'].'" onclick="return checkConfirm()"><mark>LULUSKAN TEMPAHAN</mark></a><b></center></div>';
