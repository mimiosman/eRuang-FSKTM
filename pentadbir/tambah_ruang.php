...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<h3>TAMBAH RUANG BARU</h3>
			
	
	<?php

echo"
<form method=POST action='tambah_ruang_proses.php' >

Nama Ruang&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=text name=nama_ruang size=40 maxlength=100 required ><br>

<br>Aras&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
<input type=text name=aras  size=10 maxlength=20 required><br>
