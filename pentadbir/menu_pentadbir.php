  ...
  <tr>
    <td>
		...
		<div id="clockdate">
				...
				<ul>
			<li><a class="active" href="menu_pentadbir.php">Utama</a></li><hr>
		<li class="dropdown">
...
?>
		...
		<font color="gray" size="2"><p align="center">
			<?php
					...
					{
					echo "<img src='staf/".$row['imej']."' height='80' width='80' border='2'/><br>";
					echo $row['nama'];
					}
					?> </font></p>
			<img src="../imej/line1.png"  width="560" height="60">
			 <br /> <br />
			<center><a href="tempahan_terbaru.php">Tempahan Terbaru</a> 
				
				<font color="black">(<?php
include("../database.php");
$result = mysql_query("SELECT * FROM tempahan WHERE status='DALAM PROSES' ORDER BY date ASC");
$rows = mysql_numrows($result);	
echo '<font size="2" color="red"><b>' . $rows. '</b></font>';
?>)</font>
 <br />
 <br />
		 <a href="tambah_ruang.php" >Tambah Ruang</a> <b>/</b> <a href="padam_ruang.php" >Padam Ruang</a><br>
		 <br />
		 <!--<a href="lupa_katalaluanFORM.php" >Tambah Jadual</a><br>-->

	  <!--<a href="senarai_tempahan_lulus.php">Senarai Tempahan Yang Telah Diluluskan</a>-->	
</center>
		...
		<!-- <center> sssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssaaaaewrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr</center>-->
        </form>
