...
<tr>
  ...
  <div class="outerDiv">
		...
		<div class="dropdown-content">
			<a href="notis_baru.php" class="active">Notis Baru</a>
...
?>
		...
		<font color="gray" size="2"><p align="center">
			...
			<div align="center" >
		<form action="notis_hantar.php" method="post">
		<h3>Notis Baru</h3><hr/>
		...
		Mesej<br>
		<textarea type="text" required name="mesej"  rows="10" cols="70"></textarea><br/><br/>
