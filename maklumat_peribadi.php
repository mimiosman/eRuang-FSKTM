...
<tr>
  ...
  <div class="outerDiv">
			...
			<?php
							$no_id = $_SESSION['no_id'];
							$result = mysql_query("SELECT * FROM pengguna where no_id = '$no_id' ");
							while($row = mysql_fetch_array($result))
								{
									//echo '<tr class="record">';
								
									echo "<center><img src='profil/".$row['imej']."' height='150' width='150' border='2'<br></center>";
									echo "<br>";
									echo '<div style="border: 1px dotted      #000000; "><b>Nombor Matrik:&nbsp;&nbsp;</b>'.$row['no_id'].'</div>';
								...
								//	echo '<div style="border: 1px dotted      #000000;"><b>Nombor Whatsapp:&nbsp;&nbsp;</b>'.$row['no_was'].'</div>'; 
									...
									echo '<p align="center"><a rel="facebox" href="kemaskini_maklumat.php?no_id='.$row['no_id'].'">Kemaskini Maklumat</a></p>';
