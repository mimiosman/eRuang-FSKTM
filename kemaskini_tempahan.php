  ...
  <tr>
    <td bgcolor="#000033"><table width="724" border="0">
      <ul>
		...
		<div class="dropdown-content">
			<a href="kemaskini_tempahan.php" class="active">Kemaskini Tempahan</a>
...
<tr>
  ...
  <div class="outerDiv">
			...
			<font color="gray"><b>KEMASKINI TEMPAHAN:</b></font><br><br>
    ...
    <div class="divTableRow">
		...
		<div class="divTableCellhd">Kemaskini</div>
...
<?php
            ...
            $no_id = $_SESSION['no_id'];
            $sql = "select * FROM tempahan  where no_id = '$no_id' AND status='DALAM PROSES' ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
            ...
            if($i%2==0){
				...
				echo '<div class="divTableCell" ><a href="batalkan_tempahan.php?id='.$row2['id'].'"  onclick="return checkConfirm()"><center><img src="imej/delete1.png" width="30" height="30" align="middle"/></center></a></div>';
			...
			<br>
			<center><?php 
			$sql = "select * FROM tempahan where no_id = '$no_id' AND status='DALAM PROSES' "; 
